...
variable "sync_repo" {
  ...
  default     = "https://source.developers.google.com/p/fleet-project-8e67/r/acm"
}
...
variable "gcp_service_account_email" {
  type        = string
  description = "(optional) describe your variable"
  default     = "configconnector@fleet-project-8e67.iam.gserviceaccount.com"
}
